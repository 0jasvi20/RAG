...
# 
#         if text_by_page:
#             print(f"✅ Successfully extracted text from {len(text_by_page)} pages using pdfplumber")
#             return text_by_page
# 
...
#             print("⚠️ Creating dummy text for testing...")
#             return [{
...
#                 })
# 
#         print(f"✅ Created {len(chunks)} text chunks from {len(text_by_page)} pages")
#         return chunks
# 
#     def embed_text(self, text_chunks):
#         """Create embeddings for text chunks"""
#         if not self.embed_model:
#             print("⚠️ No embedding model, using fallback...")
...
#             return
# 
#         print(f"📥 Creating index with {len(embeddata.embeddings)} text chunks...")
# 
...
#                         st.write(f"• Text chunks extracted: {len(embeddata.text_chunks)}")
